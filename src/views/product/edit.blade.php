		...
		<div class="col-sm-12">
			<section class="panel">
				...
				<div class="panel-body">
					<form role="form" method="post" class="f1 clearfix" action="{{url('admin/product/update',$product->id)}}" enctype="multipart/form-data">
						{{ csrf_field() }}
						...
						<div id="tiengViet" class="tab-pane fade in active">
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="title" id="title" required  value="{{$product->name}}">
									</div>
								</div>
							</div><!-- end: .form-group -->
										...
										<div class="fileupload fileupload-new" data-provides="fileupload">
											<div class="pull-left">
												<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
													<img src="{{asset('images/sanpham/'.$product->image)}}" alt="" />
												</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="oldPrice" id="oldPrice" value="{{$product->unitprice}}" >
									</div>
								</div>
							</div>
							...
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="baohanh" id="baohanh" value="{{$product->baohanh}}" >
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-5">
										<input type="text" class="form-control" name="shortDesc" id="shortDesc" value="{{$product->description}}" >
									</div>
								</div>
							</div>
							<div class="form-group">
								<div class="row">
									...
									<div class="col-md-9">
									 <textarea name="content1" id="content1"> {{$product->content}}</textarea>
        							<script>
