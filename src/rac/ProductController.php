...
class ProductController extends Controller
{
    public function index()
    {
    	...
    	return view('vendor.ViciAdmin.admin.product.index',compact('product',$product));
    }
     public function create()
    {
    	$prodtype=ProductGroup::all();
    	return view('ViciCMS::admin.product.insert',compact('prodtype',$prodtype));
    }
    public function edit($id)
    {
        $prodtype=ProductGroup::all();
    	$product=Product::where('id',$id)->first();
    	return view('ViciCMS::admin.product.edit',compact('product',$product,'prodtype',$prodtype));
    }
    ...
    public function timkiem($key)
    {
        ...
        return view('ViciCMS::admin.product.search',compact('product',$product));
    }
