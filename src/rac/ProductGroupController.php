...
class ProductGroupController extends Controller
{
    public function index()
    {
    	...
    	return view('admin.product-group.show',compact('prodGroup',$prodGroup));
    }
     public function create()
    {
    	return view('admin.product-group.insert');
    }
    public function edit($id)
    {
        // $prodtype=ProductGroup::all();
    	$prodGroup=ProductGroup::find($id);
    	return view('admin.product-group.edit',compact('prodGroup',$prodGroup));
    }
