...
class ProviderController extends Controller
{
    public function index()
    {
    	...
    	return view('ViciCMS::admin.provider.index',compact('prodGroup',$prodGroup,'collection',$collection));
    }
     public function create($id)
    {
    	$prodGroup=ProductGroup::find($id);
    	return view('admin.provider.insert',compact('prodGroup',$prodGroup));
    }
